    ...
    <section className="intro">
      <Container>
        ...
        <p>
          ...
          bezpieczeństwa państwa i obywateli. Konferencja skierowana jest do
          kadry kierowniczej i zarządzającej przedsiębiorstw:
        </p>
        <ul>
